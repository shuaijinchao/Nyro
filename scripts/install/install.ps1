...
# Usage: irm https://raw.githubusercontent.com/shuaijinchao/nyro/master/scripts/install/install.ps1 | iex
#
...
function Get-ReleaseVersion {
    ...
    Write-Host '  $Version = "1.0.0"; irm https://raw.githubusercontent.com/shuaijinchao/nyro/master/scripts/install/install.ps1 | iex' -ForegroundColor Yellow
    return $false
}
